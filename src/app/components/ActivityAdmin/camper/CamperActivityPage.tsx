...
interface CamperActivityProps {
  data: CamperActivityApi | { error: unknown; status: "error" } | undefined;
}

export interface CamperActivityApi {
  status: "success";
  data: CamperActivityData[];
}

export default function CamperActivityPage({ data }: CamperActivityProps) {
