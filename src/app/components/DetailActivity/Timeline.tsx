            ...
            {schedule.map((data, index) => {
                ...
                return (
                    <li key={index}>
                        ...
                        <div className={`px-4 timeline-end ${index % 2 === 1 ? "md:text-end md:timeline-start" : ""}`}>
                            <time>{convertDateToThai(data.date)}</time>
                            <div className="text-lg text-neonBlue">{data.title}</div>
                            <div className="timeline-end timeline-box mx-0">
                                <p>{data.details}</p>
                            </div>
                        </div>
